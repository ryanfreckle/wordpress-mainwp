# MainWP Development Extension - Child
...
```
node bin/plugin/dist.js mainwp-development-extension-child
```

That produces `dist/mainwp-development-extension-child.zip`. Install it on your child sites
either:
